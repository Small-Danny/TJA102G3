...
(function (factory) {
			...
			_.initials = {
				...
				dates: {
					...
					tw: {
						...
						noEventForToday: '今天沒有運動計畫唷，休息一下吧 :)',
						noEventForThisDay: '今天沒有運動計畫唷，休息一下吧 :)',
						previousYearText: '前一年',
						nextYearText: '後一年',
						closeSidebarText: '關閉側邊欄',
						closeEventListText: '關閉運動清單'
					},
					es: {
						days: [
							'Domingo',
	...
	EvoCalendar.prototype.buildTheBones = function () {
		...
		if (!_.$elements.calendarEl.html()) {
			...
			//                 '</button>'+
			//                 '&nbsp;<p class="calendar-year-title-text"></p>&nbsp;'+
	...
	EvoCalendar.prototype.buildSidebarYear = function () {
		...
		_.$elements.sidebarEl
			.find('.calendar-year > .calendar-year-title-text')
			.text(_.$active.year);
	};
