...
--
-- Final Corrected and Merged Version by Gemini @ 2025-10-01
--
...
`is_subscribed` tinyint NOT NULL DEFAULT '0' COMMENT '是否訂閱電子報 (0:否, 1:是)',
PRIMARY KEY (`user_id`),
...
`reserved_stock` int NOT NULL DEFAULT 0 COMMENT '已預留庫存(下單未付款時先鎖定)',
...
`task_icon` BLOB NULL COMMENT '任務圖騰（位元組）' ,
...
`sport_type_name` VARCHAR(50) NOT NULL COMMENT '運動分類名稱',
`sport_type_pic` VARCHAR(255) DEFAULT NULL COMMENT '運動分類圖片',
`sport_type_data_status` TINYINT NOT NULL DEFAULT 1 COMMENT '運動分類資料狀態',
`create_datetime` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '建立時間',
`update_datetime` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最後更新時間',
PRIMARY KEY (`sport_type_id`),
UNIQUE KEY `sport_type_name` (`sport_type_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='運動分類表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
`sport_name` VARCHAR(50) NOT NULL COMMENT '運動名稱',
`sport_description` VARCHAR(255) DEFAULT NULL COMMENT '運動描述',
`sport_mets` DECIMAL(4,2) NOT NULL COMMENT '運動強度',
`sport_estimated_calories` INT UNSIGNED NOT NULL COMMENT '預估運動消耗熱量',
`sport_level` VARCHAR(20) NOT NULL COMMENT '運動等級',
`sport_pic` VARCHAR(255) DEFAULT NULL COMMENT '運動圖片',
`sport_data_status` TINYINT NOT NULL COMMENT '運動資料狀態',
`admin_id` INT NOT NULL COMMENT '建立管理員ID',
`create_datetime` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '建立時間',
`update_datetime` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最後更新時間',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系統運動項目表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CONSTRAINT `fk_sport_type_item_sport_type_id` FOREIGN KEY (`sport_type_id`) REFERENCES `sport_type` (`sport_type_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='運動分類明細表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
`sport_pic` VARCHAR(255) DEFAULT NULL COMMENT '運動圖片',
`sport_data_status` TINYINT NOT NULL COMMENT '運動資料狀態',
`user_id` INT NOT NULL COMMENT '建立會員ID',
`create_datetime` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '建立時間',
`update_datetime` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最後更新時間',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='使用者自訂義運動項目表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
`workout_plan_name` VARCHAR(50) NOT NULL COMMENT '運動計畫名稱',
`user_id` INT NOT NULL COMMENT '使用者ID',
`sport_from` VARCHAR(20) NOT NULL COMMENT '運動項目來源',
...
`workout_plan_time` TIME DEFAULT NULL COMMENT '計畫安排時間',
`workout_plan_is_notify` TINYINT NOT NULL DEFAULT 0 COMMENT '是否提醒 (0=不提醒, 1=提醒)',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='運動計畫表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
`calorie_count_method` INT NOT NULL DEFAULT 1 COMMENT '熱量計算方式（1=估算, 2=體重計算, 3=自填）',
...
`actual_record_datetime` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '實際做紀錄的日期時間',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='運動計畫實際執行紀錄表';
/*!40101 SET character_set_client = @saved_cs_client */;
