...
public class AiController {
    ...
    //步驟3:用 HttpClient 建立一個 HTTP POST 請求，送到 https://ollama.com/api/chat。
            ...
            requestBody.put("messages", List.of(
                    Map.of("role", "user", "content", "請幫我不足20字時寫成300字文章,300字以上的話幫我優化文章\n" + contentForAI)
            ));
            requestBody.put("temperature", 0.7);
            requestBody.put("stream", false);
            ObjectMapper mapper = new ObjectMapper();
            
            //輸出結果{"model": "gpt-oss:120b-cloud","messages": [{"role": "user","content": "請幫我不足20字時寫成300字文章,300字以上的話幫我優化文章\n文章內容..."}],"temperature": 0.7,"stream": false} 
            
            String json = mapper.writeValueAsString(requestBody);

            HttpRequest request = HttpRequest.newBuilder()
                    .uri(URI.create("https://ollama.com/api/chat"))
