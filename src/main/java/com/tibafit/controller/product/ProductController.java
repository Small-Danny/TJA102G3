...
public class ProductController {
	...
	public String routeGet(@RequestParam(value = "action", required = false) String action,
	...
	public String routePost(@RequestParam("action") String action,
			@RequestParam(value = "product_id", required = false) Integer id, ProductVO form, Model model,
